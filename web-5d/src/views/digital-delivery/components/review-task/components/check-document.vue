 ...
 * @LastEditTime: 2021-03-18 15:08:09
    ...
    <el-main style="width:100%">
      <el-table :data="data" style="width: 100%" :row-class-name="getRowClass">
            ...
            <el-table :data="scope1.row.pdcdoc" class="drawer">
              ...
              <el-table-column>
                <template slot-scope="scope">
                  <el-button v-if="permission.indexOf('docAuditTask:browse') !== -1" type="text" @click="browseClick(scope.row)">浏览</el-button>
                  <el-button v-if="permission.indexOf('docAuditTask:download') !== -1" type="text" @click.native="uploadClick(scope.row)">下载</el-button>
                </template>
              </el-table-column>
            </el-table>
          </template>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button v-if="permission.indexOf('docAuditTask:audit') !== -1" :disabled="scope.row.status === '3'" type="text" @click.native="okCick(scope.row)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-main>
