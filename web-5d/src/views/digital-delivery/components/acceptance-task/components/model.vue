 ...
 * @LastEditTime: 2021-03-18 15:05:56
  ...
  <el-container>
    <el-main style="width:100%">
      <el-table :data="data" style="width: 100%" :row-class-name="getRowClass">
            ...
            <el-table :data="scope1.row.pdmflist" class="drawer">
              ...
              <el-table-column>
                <template slot-scope="scope">
                  <el-button v-if="permission.indexOf('modelAcceptance:browse') !== -1" type="text" @click.native="browseClick(scope.row)">浏览</el-button>
                  <el-button v-if="permission.indexOf('modelAcceptance:download') !== -1" type="text" @click.native="uploadClick(scope.row)">下载</el-button>
                </template>
              </el-table-column>
            </el-table>
          </template>
        ...
        <el-table-column label="名称" prop="contentNo"> </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button v-if="permission.indexOf('modelAcceptance:acceptance') !== -1" :disabled="scope.row.status === '2'" type="text" @click.native="okCick(scope.row)">验收</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-main>
